...
class SimpleRAGBot:
    ...
    Шаги размышления:
    1. Я проанализирую информацию, найденную в фрагментах.
    2. Я постараюсь собрать факты о из данной информации.
    3. Я сформулирую ответ на основе собранных фактов или сообщу, если информации недостаточно.
    """

        prompt = f"""{reasoning_steps}

    На основе приведенного контекста, дайте точный ответ на вопрос. Если в контексте нет достаточной информации, скажите "Я не знаю". Ответ:"""
